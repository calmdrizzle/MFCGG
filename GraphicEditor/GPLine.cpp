...
void GPLine::set(int left, int top, int right, int bottom)
{
	point.x = left;
	point.y = top;
	point_end.x = right;
...
void GPLine::move(int dx, int dy)
{
	if (movemode == -1)
	{
...
void GPLine::drawBoundary(CDC* cdc)
{
...
void GPLine::serialize(CArchive &ar, bool serialize_flag){
